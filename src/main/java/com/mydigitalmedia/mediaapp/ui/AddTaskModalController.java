...
public class AddTaskModalController {
    ...
    @FXML
    public HBox clearFieldsAndCreateTaskButtonsHbox;
    @FXML
    ...
    @FXML
    private void handleCreateTaskAction() throws SQLException, IOException {
        ...
        if(!isAnyFiledEmpty){
            ...
            SerializedPair<Task, String> taskPair = new SerializedPair<>(task, "created", MainApplication.user);
            ...
            Thread thread2 = new Thread(() -> {
                ...
                fileUtils.addObjectToFile(taskPair, "dat/created.dat");
            });
            ...
            StackPane parentStackPane = (StackPane) mainPane.getScene().getRoot();
            parentStackPane.getChildren().remove(MainApplication.preloadedContent.get("addTaskModal"));
        }
    ...
    private void initMainPane() throws SQLException, IOException {
        ...
        addTaskVbox.getStyleClass().add("add-task-vbox");
        addTaskVbox.setLayoutX(260);
        addTaskVbox.setLayoutY(50);
        initHboxes();
        initLabels();
        initTextFields();
        setCloseButtonIcon();
    ...
    private void initHboxes(){
        ...
        clearFieldsAndCreateTaskButtonsHbox.getStyleClass().add("clear-fields-and-create-task-buttons-hbox");
        clearFieldsAndCreateTaskButtonsHbox.setSpacing(20);
    ...
    private void initLabels(){
        ...
        modalTitleLabel.setText("ADD TASK");
    ...
    public void initButtons(){
        ...
        createTaskButton.getStyleClass().add("createTask-button");
        createTaskButton.setText("ADD TASK");

        HBox.setMargin(clearFieldsButton, new Insets(36, 0, 0, 80));
        HBox.setMargin(createTaskButton, new Insets(36, 0, 0, 84));
