...
public class TikTokData extends SocialMediaData implements Engageable {
    ...
    public TikTokData(String profileName) {
    ...
    public void fetchData() {
        ...
        try {
            profileData = socialMediaService.getProfile("https%3A%2F%2Fwww.tiktok.com%2F%40" + profileName);
